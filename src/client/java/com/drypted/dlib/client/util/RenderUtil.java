...
public class RenderUtil {
     ...
     */
    public static void drawSprite(GuiGraphics g, Identifier sprite, int x, int y, int width, int height) {
     ...
     * @param height   Height in pixels
     */
    public static void drawSprite(GuiGraphics g, RenderPipeline pipeline, Identifier sprite, int x, int y, int width, int height) {
     ...
     */
    public static void drawItemIcon(GuiGraphics g, ItemStack stack, int x, int y, int width, int height) {
        if (stack == null || stack.isEmpty()) return;
        try {
            g.renderFakeItem(stack, x, y);
            g.renderItemDecorations(Minecraft.getInstance().font, stack, x, y, null);
